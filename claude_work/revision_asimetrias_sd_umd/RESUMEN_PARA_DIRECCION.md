...
**Prueba con la simulación.** Se leyeron conteos MC ya guardados en 20 archivos ADST de protones SIBYLL 2.3e, incluyendo estaciones que el lector del parquet descartaba por no tener contraparte SD reconstruida. No se ejecutaron nuevas simulaciones. Con geometría MC, 30 ≤ θ < 40°, 1200 ≤ r < 1350 m, doce bins azimutales y el ajuste ponderado del gráfico original, se obtuvo A₁(SD) = **+0.069 antes** y **-0.124 después** del requisito, frente a **+0.082 para UMD**. A₁ positivo significa exceso temprano. La diferencia SD antes − UMD es -0.013, con intervalo bootstrap pareado del 95% [-0.090, +0.055]: compatible con cero en esa banda, pero las curvas no coinciden en todo el rango radial.
