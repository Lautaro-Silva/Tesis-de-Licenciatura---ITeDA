...
\begin{frame}{El problema abierto: composición de masa}
  \begin{columns}[T]
    ...
    \column{0.52\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.6cm,keepaspectratio]{x_max.jpg}
  \end{columns}
\end{frame}
...
\begin{frame}{Anatomía de una lluvia: dos componentes muy distintas}
  \begin{columns}[T]
    ...
    \column{0.52\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.8cm,keepaspectratio]{eas.png}
  \end{columns}
\end{frame}
...
\begin{frame}{El plano de la lluvia y la ruptura de simetría}
  \begin{columns}[T]
    ...
    \column{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.6cm,keepaspectratio]{esquema_lluvia.jpeg}
  \end{columns}
\end{frame}
...
\begin{frame}{¿Qué explica la inversión del SD?}
  % Intencionalmente en blanco: contenido a rediseñar por el autor.
\end{frame}
...
\begin{frame}{El núcleo reconstruido se corre a lo largo del eje temprano-tardío}
  ...
  \begin{columns}[T]
    \column{0.55\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=4.4cm,keepaspectratio]{error_radial_azimut.jpg}
    \column{0.4\textwidth}
      \begin{itemize}\small
        \item Eje vertical: \textbf{error en la posición del núcleo}
          reconstruido respecto a la posición real de Monte Carlo
...
\begin{frame}{Por qué: una LDF simétrica ajustada a una señal asimétrica}
  \badgeMC
  \small\textbf{Motivación}: ¿por qué $A_1^{REC}$ pierde magnitud respecto
  a $A_1^{MC}$?
  \begin{columns}[T]
    \column{0.37\textwidth}
      \begin{itemize}\small
        ...
        \item El residuo de conteo tiene \textbf{media cercana a cero},
          pero su distribución no es simétrica: cola de
          sobre-reconstrucción, mayor en la región tardía.
      \end{itemize}
    \column{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{muon_counting_validation.pdf}
    \column{0.3\textwidth}
      \centering
      \includegraphics[width=\textwidth,height=3.2cm,keepaspectratio]{toy_model.pdf}
  \end{columns}
