...
Análogamente, se comparó la evolución de $A_1$ para un mismo primario y energía utilizando diferentes librerías para las interacciones hadrónicas. Dada la disponibilidad de datos se compararon las lluvias de primario helio con los modelos \texttt{SIBYLL 2.3e} y \texttt{EPOS-LHC}. Aunque no es obvio que ambos modelos deban predecir densidades totales de muones identicas (dado que puede haber un déficit muónico diferente entre ellos), la modulación relativa $A_1$ debería presentar una consistencia cualitativa que valide su uso como trazador de la composición y que ademas permita combinar los resulatdos de ambas lluvias para lograr mayor estadística. Para esto se realizo un análisis similar al realizado en la seccion \ref{subsec:entorno_control} donde se separaron los datos en función de su angulo cenital de entrada. A su vez se calculo la diferencia por bin con su respectiva propagación de errores. Esto se puede  ver en la Figura \ref{fig:modelos_hadronicos}.
