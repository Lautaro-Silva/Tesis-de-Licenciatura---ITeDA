...
\begin{enumerate}
	...
	\item \textbf{Umbral Cinemático (\textit{Muones Duros}):} La pérdida de energía por ionización que sufren los muones al atravesar los $2.3\text{ m}$ de tierra impone un umbral de energía estricto. Solo los muones con una energía superior a $E_\mu \gtrsim 1\text{ GeV}$ son capaces de alcanzar los detectores subterráneos. 
\end{enumerate}
