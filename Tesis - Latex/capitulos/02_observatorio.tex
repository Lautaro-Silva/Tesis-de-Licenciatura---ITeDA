...
El UMD constituye el núcleo experimental de esta tesis. Está compuesto por detectores de centelleo plástico enterrados junto a las estaciones WCD. Cada estación de detección muónica consta de tres módulos de $10\text{ m}^2$ cada uno, sumando un área total de detección de $30\text{ m}^2$ por posición. A su vez, cada módulo está segmentado finamente en 64 tiras de centellador. Estas tiras cuentan con fibras ópticas que conducen los fotones producidos por el paso de partículas cargadas hacia un arreglo de 64 fotomultiplicadores de silicio (SiPMs). Una imagen representativa de la estación se puede ver en la Figura \ref{fig:umd_station}.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{capitulos/imagenes_capitulos/cap2/umd.png}
	\caption{Esquema de Detector Subterráneo de Muones junto a su estación de superficie asociada donde se observa la distribución de los tres módulos centelladores. Obtenido de \cite{botti2019}.}
	\label{fig:umd_station}
\end{figure}
