...
% [ACÁ VA EL GRÁFICO: Curvas superpuestas de A1(r) para el UMD vs SD Total]
% \begin{figure}[htbp] ... \label{fig:umd_vs_sd_mc} ... \end{figure}
...
% [ACÁ VA EL GRÁFICO: Desglose del SD (EM positiva, Muones negativos) vs UMD (positivo)]
% \begin{figure}[htbp] ... \label{fig:desglose_sd_mc} ... \end{figure}
