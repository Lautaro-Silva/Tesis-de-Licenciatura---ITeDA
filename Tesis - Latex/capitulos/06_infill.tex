...
% Acá discutimos la necesidad de no mezclar regímenes (ej. 0-200m)
% Mostramos que el UMD puro se ajusta perfecto a un coseno (los chi-cuadrados)
% Mostramos cómo el A1 sube de negativo a positivo (Crossover).

\subsubsection{Competencia de observables: UMD frente al SD Total}
% Comparamos la curva A1(r) del UMD vs la curva errática del SD.
% Mostramos que a distancias grandes el SD hace "cosas raras".

\subsubsection{Desglose de señales: La inversión de la asimetría muónica}
% El gran descubrimiento: Rompemos el SD en Muones y EM.
% Mostramos que el SD falla porque suma una EM muy positiva con Muones SD muy negativos.
